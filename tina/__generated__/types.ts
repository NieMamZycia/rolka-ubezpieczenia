...
export type Homepage = Node & Document & {
  ...
  contact_address?: Maybe<Scalars['String']['output']>;
  id: Scalars['ID']['output'];
  _sys: SystemInfo;
  _values: Scalars['JSON']['output'];
};
...
export type HomepageMutation = {
  ...
  contact_address?: InputMaybe<Scalars['String']['input']>;
};

export type HomepagePartsFragment = { __typename: 'Homepage', hero_title: string, hero_subtitle?: string | null, hero_image?: string | null, about_text?: any | null, contact_phone?: string | null, contact_email?: string | null, contact_address?: string | null };
...
export type HomepageQuery = { __typename?: 'Query', homepage: { __typename: 'Homepage', id: string, hero_title: string, hero_subtitle?: string | null, hero_image?: string | null, about_text?: any | null, contact_phone?: string | null, contact_email?: string | null, contact_address?: string | null, _sys: { __typename?: 'SystemInfo', filename: string, basename: string, hasReferences?: boolean | null, breadcrumbs: Array<string>, path: string, relativePath: string, extension: string } } };
...
export const ExperimentalGetTinaClient = () =>
  getSdk(
    generateRequester(
      createClient({
        url: "https://content.tinajs.io/2.2/content/8a756483-aeec-4b53-8959-6fc3807ce006/github/main",
        queries,
      })
    )
  )
